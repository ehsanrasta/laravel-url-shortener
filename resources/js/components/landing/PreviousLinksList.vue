<template>
    <div class="rounded mt-10 bg-white p-8 shadow w-full md:w-2/3 mx-auto">
        <p class="uppercase font-semibold text-gray-600">Links</p>
        <ul>
            <li v-for="link in previousLinks" :key="link.id" class="flex flex-row mt-6 border-b border-gray-300">
                <i class="fas fa-link text-xl bg-purple-100 text-purple-500 p-2 rounded self-center"></i>
                <div class="flex flex-col ml-8  w-full pb-3">
